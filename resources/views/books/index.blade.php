...
<div class="library-stats">
    <div class="row text-center">
        ...
        <div class="col-6 col-md-3">
            ...
            <h3 class="mb-0">{{ $books->currentPage() }}</h3>
        ...
        <div class="col-12 mb-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <span class="badge bg-primary me-2">{{ $books->count() }} buku</span>
                ...
                <div class="book-card h-100">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('books.show', $book) }}">
                                        <i class="fas fa-eye me-2"></i>Lihat Detail
                                    </a></li>
                                    <li><a class="dropdown-item" href="{{ route('books.edit', $book) }}">
                    ...
                    <div class="book-content">
                        ...
                        <div class="book-author">
                            <i class="fas fa-feather-alt me-2"></i>{{ $book->author }}
                        </div>
                        ...
                        @endphp
                        <span class="genre-badge">{{ $randomGenre }}</span>
                        
                        <!-- Reading Progress (Random) -->
                        <div class="reading-progress" style="width: {{ rand(30, 100) }}%"></div>
                    </div>
                    ...
                    <div class="book-actions">
                        <div class="row g-2">
                            <div class="col-4">
                                <a href="{{ route('books.show', $book) }}" class="btn btn-outline-info btn-sm w-100">
                                    <i class="fas fa-book-reader"></i>
                                    <div class="d-none d-lg-inline ms-1">Baca</div>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="{{ route('books.edit', $book) }}" class="btn btn-outline-warning btn-sm w-100">
                                    <i class="fas fa-edit"></i>
                                    <div class="d-none d-lg-inline ms-1">Edit</div>
                                </a>
                            </div>
                            <div class="col-4">
                                <form action="{{ route('books.destroy', $book) }}" method="POST" class="w-100">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center p-4 bg-light rounded">
                    <div class="mb-3 mb-md-0 text-center text-md-start">
                        <span class="text-muted">
                            ...
                            ({{ $books->firstItem() }}-{{ $books->lastItem() }} dari {{ $books->total() }} buku)
                        </span>
                    </div>
                    <div>
...
<!-- Floating Add Button -->
<a href="{{ route('books.create') }}" class="floating-add-btn d-flex align-items-center justify-content-center" 
